                        ...
                        <div class="cartlist">
                            ...
                            <div class="cartlist-data">
                                ...
                                if (isset($_COOKIE['cartCookie']) && !empty(json_decode($_COOKIE['cartCookie']))) {
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <?php foreach ($cartArray as $course_id) {
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="d-flex bd-highlight">
                                                                <div class="pr-2 flex-fill bd-highlight"><a href="include/UserSubmitData.php?moduleMethod=cart&module=deleteCartFromDash&remove=<?php echo $course_id; ?>">Remove</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                        ...
                                        <div class="col-md-3">
                                            <div class="p-2" style="background-color: #ffecec; border-radius: 10px;">
                                                <div class="d-flex flex-column bd-highlight">
                                                    ...
                                                    <a href="userLogin.php?withoutLogin=withoutLogin&checkbuy=cart" class="mt-3 bt-boder-0 btn btn-primary btn-100">Checkout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="d-flex bd-highlight">
                                                                <div class="pr-2 flex-fill bd-highlight"><a href="include/UserSubmitData.php?moduleMethod=cart&module=deleteCourseFromDashboard&cource_id=<?php echo $row['cource_id']; ?>">Remove</a></div>
                                                                <div class="pr-2 pl-2 flex-fill bd-highlight"><a href="">Move to Wishlist</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
